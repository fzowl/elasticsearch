...
public class VoyageAIService extends SenderService<VoyageAIModel> implements RerankingInferenceService {
    ...
    private static final String SERVICE_NAME = "Voyage AI by MongoDB";
    ...
    // Maximum number of inputs sent per request when chunking. Models absent from this map fall back to DEFAULT_BATCH_SIZE.
    // See the available models at https://docs.voyageai.com/docs/embeddings
    private static final Map<String, Integer> MODEL_BATCH_SIZES = Map.ofEntries(
        // Current-generation models
        Map.entry("voyage-4-large", 7),
        Map.entry("voyage-4", 7),
        Map.entry("voyage-4-lite", 7),
        Map.entry("voyage-4-nano", 7),
        ...
        Map.entry("voyage-multilingual-2", 7),
